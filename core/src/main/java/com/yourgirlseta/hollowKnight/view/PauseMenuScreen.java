...
import com.yourgirlseta.hollowKnight.controller.PauseMenuController;
...
public class PauseMenuScreen
    ...
    public PauseMenuScreen(
        ...
        controller = new PauseMenuController(game.getSettingsManager());
            ...
            new ChangeListener() {
                ...
                public void changed(
                    ...
                    game.setScreen(
                        new CheatMenuScreen(
                            game,
                            PauseMenuScreen.this,
                            gameScreen,
                            gameScreen.getPlayer(),
                            gameScreen.getCheatManager()
                        )
                    );
                }
            }
    ...
    public void render(
        ...
        if ( controlsManager.isPauseMenuPressed()) {
            game.setScreen(
                gameScreen
            );
        }
